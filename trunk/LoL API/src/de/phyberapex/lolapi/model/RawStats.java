...
public class RawStats {
	...
	public int getConsumbablesPurchased() {
		return consumbablesPurchased;
	}

	public void setConsumbablesPurchased(int consumbablesPurchased) {
		this.consumbablesPurchased = consumbablesPurchased;
	}
	...
	public int getLargestMulitKill() {
		return largestMulitKill;
	}

	public void setLargestMulitKill(int largestMulitKill) {
		this.largestMulitKill = largestMulitKill;
	}
	...
	public int getSummSpell1Cast() {
		return summSpell1Cast;
	}

	public void setSummSpell1Cast(int summSpell1Cast) {
		this.summSpell1Cast = summSpell1Cast;
	}

	public int getSummSpell2Cast() {
		return summSpell2Cast;
	}

	public void setSummSpell2Cast(int summSpell2Cast) {
		this.summSpell2Cast = summSpell2Cast;
	}
