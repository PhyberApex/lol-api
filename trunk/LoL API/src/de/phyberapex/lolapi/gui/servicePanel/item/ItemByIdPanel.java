...
public class ItemByIdPanel extends JPanel {
	...
	private void createGUI() {
		this.setBorder(BorderFactory.createTitledBorder("getItempById(int id)"));
		...
		this.resultLabel = new JLabel("Item name");
