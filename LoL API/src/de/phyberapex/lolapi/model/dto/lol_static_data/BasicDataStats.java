...
/**
 * This class represents the DTO "BasicDataStats" for the lol-static-data API by
 * riot
 * 
...
public class BasicDataStats {
	...
	private double FlatAttackSpeedMode;
	...
	private double PercentageArmorMod;
	private double PercentAttackSpeedMode;
	...
	private double rFlatCritDamageMod‹erLevel;
	private double rFlatDodgeMod;
	private double rFlatDodgeModePerLevel;
	...
	private double rFlatPenetrationMod;
	...
	public double getFlatAttackSpeedMode() {
		return FlatAttackSpeedMode;
	}

	public void setFlatAttackSpeedMode(double flatAttackSpeedMode) {
		FlatAttackSpeedMode = flatAttackSpeedMode;
	}
	...
	public double getPercentageArmorMod() {
		return PercentageArmorMod;
	}

	public void setPercentageArmorMod(double percentageArmorMod) {
		PercentageArmorMod = percentageArmorMod;
	}

	public double getPercentAttackSpeedMode() {
		return PercentAttackSpeedMode;
	}

	public void setPercentAttackSpeedMode(double percentAttackSpeedMode) {
		PercentAttackSpeedMode = percentAttackSpeedMode;
	}
	...
	public double getrFlatCritDamageMod‹erLevel() {
		return rFlatCritDamageMod‹erLevel;
	}

	public void setrFlatCritDamageMod‹erLevel(double rFlatCritDamageMod‹erLevel) {
		this.rFlatCritDamageMod‹erLevel = rFlatCritDamageMod‹erLevel;
	}
	...
	public double getrFlatDodgeModePerLevel() {
		return rFlatDodgeModePerLevel;
	}

	public void setrFlatDodgeModePerLevel(double rFlatDodgeModePerLevel) {
		this.rFlatDodgeModePerLevel = rFlatDodgeModePerLevel;
	}
	...
	public void setrFlatEnergyRegenModPerLevel(
	...
	public void setrFlatMagicDamageModPerLevel(
			double rFlatMagicDamageModPerLevel) {
		this.rFlatMagicDamageModPerLevel = rFlatMagicDamageModPerLevel;
	}

	public double getrFlatPenetrationMod() {
		return rFlatPenetrationMod;
	}

	public void setrFlatPenetrationMod(double rFlatPenetrationMod) {
		this.rFlatPenetrationMod = rFlatPenetrationMod;
	}
	...
	public void setrPercentArmorPenetrationMod(
	...
	public void setrPercentCooldownModPerLevel(
	...
	public void setrPercentMagicPenetrationMod(
	...
	public void setrPercentTimeDeadModPerLevel(
