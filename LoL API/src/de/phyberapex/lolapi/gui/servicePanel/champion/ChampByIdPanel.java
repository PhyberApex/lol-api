...
public class ChampByIdPanel extends JPanel {
	...
	private void createGUI() {
		this.setBorder(BorderFactory.createTitledBorder("getChampById(int id)"));
		...
		this.resultLabel = new JLabel("Champion name");
